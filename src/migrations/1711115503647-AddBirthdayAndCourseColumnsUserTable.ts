...
export class AddBirthdayAndCourseColumnsUserTable1711115503647 implements MigrationInterface {

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('ALTER TABLE "user" ADD COLUMN "birthDate" DATE');
    await queryRunner.query('ALTER TABLE "user" ADD COLUMN "courseEdition" INT');
